<div class="contentAbout">
	...
	<p>En Farmacia Veterinaria La Mangana ofrecemos un excelente servicio veterinario, para cuidar de la salud de perros y gatos en diversas áreas.
Contamos con instalaciones y equipo de vanguardia para la comodidad de nuestros pacientes y sus propietarios, siempre con el objetivo de dar la mejor atención. Trabajamos basándonos siempre en la honestidad, responsabilidad, respeto y sensibilidad.</p>
</div>
...
<div class="contentMap">
	...
	<img id="mapa" src="https://maps.googleapis.com/maps/api/staticmap?center=20.062929172919276, -97.05318660540844&zoom=18&size=350x350&maptype=roadmap\&markers=size:mid%7Ccolor:red%7C20.062929172919276, -97.053186605408448&key=YOUT_API_KEY" alt="Mapa">
</div>
